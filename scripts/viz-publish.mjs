...
const CAPTIONS = [
  ...
  ["financials.png", "/corporation \u2014 financials tab", "The income statement as a waterfall. A P&L is a running balance, not a set of independent quantities: this shows how revenue becomes income rather than which cost is biggest."],
  ["financials-loss.png", "/corporation \u2014 loss-making", "The closing column falls below the baseline and takes the critical ring."],
  ["profile-badges.png", "/profile \u2014 standing badges", "Supporter tier, moderator and admin, read from Discord roles. A member mid-upgrade holding both supporter roles shows only the higher one."],
